...
export default function Overview({ appData, userId }) {
  ...
  // Normalise a task with its category info
  const enrich = (t) => ({
    ...t,
  ...
  return (
    <div>
      ...
      <div style={{ marginBottom:'1.5rem' }}>
        ...
        <div style={{ background:'var(--color-bg-secondary)', borderRadius:4, height:10, overflow:'hidden' }}>
    ...
    <div className="urgency-item" onClick={() => onOpen(task)} style={{ cursor:'pointer' }}>
      ...
      <div style={{ flex:1, minWidth:0 }}>
        <div style={{ display:'flex', alignItems:'center', gap:8, flexWrap:'wrap' }}>
          ...
          <span style={{ fontSize:10, color:'var(--color-text-tertiary)', background:'var(--color-bg-secondary)', padding:'1px 6px', borderRadius:10 }}>{cadence}</span>
